...
| 27  | [UNIQ-OPT_엣지 검지 기반 단일교차로 교통신호제어 및 설계 알고리즘 개발_KAIST.pdf](./UNIQ-OPT_엣지%검지%기반%단일교차로%교통신호제어%및%설계%알고리즘%개발_KAIST.pdf) | K-Means 클러스터 기법을 활용한 유사 교통 특성 군집 기반 TOD 분할 기술에 대한 내용을 기술함 |
